...
//           <>
//             <LaunchButton command="echo Base Station Manual" terminal={1}>
//               Base Station Manual
//             </LaunchButton>

//             <LaunchButton command="ls" terminal={2}>
//               Rover Manual
//             </LaunchButton>

//             <LaunchButton command="Autonomous Mode">
//               Autonomous Mode
//             </LaunchButton>

//             <LaunchButton command="Science Base">
//               Science Base
//             </LaunchButton>
...
const ControlPanel = ({ onAction }) => {
  ...
  useEffect(() => {
    ...
    function connectROS() {
      setRosConnecting(true);
      const url = `ws://${window.location.hostname || 'localhost'}:9090`;
      const ros = new Ros({ url });
      rosRef.current = ros;
...
//     </div>
//     <div className="mt-4 text-green-400 text-3xl font-bold tracking-tight">
//       {degrees.toFixed(1)}°
//     </div>
//   </div>
// );
...
//       {label}
//     </div>
//     <div className="text-green-400 font-bold text-xl truncate font-mono">
//       {value}
//     </div>
//   </div>
// );
...
//     return <DataBox label="Coord X" value={coord.x.toFixed(2)} />;
//   };
...
//           {rosConnected ? (
//             <span className="bg-green-500/10 text-green-400 px-2 py-1 rounded border border-green-500/20 font-bold">
//               ● ROS Connected
//             </span>
//           ) : rosConnecting ? (
//             <span className="bg-yellow-500/10 text-yellow-400 px-2 py-1 rounded border border-yellow-500/20 font-bold animate-pulse">
//               ○ Connecting...
//             </span>
//           ) : (
//             <span className="bg-red-500/10 text-red-400 px-2 py-1 rounded border border-red-500/20 font-bold">
//               ○ Disconnected
//             </span>
//           )}
//         </div>
...
//           <h4 className="text-[10px] text-slate-400 font-black uppercase mb-4 tracking-widest border-l-2 border-slate-500 pl-2">
//             Power Management
//           </h4>
//           <div className="space-y-6">
//             <Metric label="BATTERY" value={`${battery.toFixed(1)}V`} percent={battery * 8} color="yellow" />
//             <Metric label="LOAD" value={`${ampere.toFixed(1)}A`} percent={ampere * 20} color="green" />
//           </div>
//           <button
//             onClick={emergencyStop}
//             className="w-full bg-red-600 text-white py-3 mt-6 hover:bg-red-500 font-black rounded shadow-lg uppercase text-sm tracking-widest transition-all active:scale-95"
//           >
//             Emergency Stop
//           </button>
//         </div>
...
//             <h4 className="text-[10px] text-white font-black uppercase tracking-widest">
//               Sensor Data
//             </h4>
//             <h4 className="text-[10px] text-slate-500 font-black uppercase tracking-widest pr-10">
//               Heading
//             </h4>
//           </div>
...
//         <h4 className="text-[10px] text-slate-500 font-black uppercase mb-3 tracking-widest">
//           Kinematics Engine
//         </h4>
